    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown {{ request()->routeIs('blog.*') ? 'active':'' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-map-marker-alt"></i>
                    <span>Blog</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown {{ request()->routeIs('gallery.*') ? 'active':'' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-bicycle"></i>
                    <span>Gallery</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown {{ request()->routeIs('staff.*') ? 'active':'' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-sync-alt"></i>
                    <span>Staff</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="{{ request()->routeIs('admin.reserve') ? 'active':'' }}">
                <a href="{{ route('admin.reserve') }}" class="nav-link"><i class="fas fa-sitemap"></i><span>Reservations</span></a>
            </li>
            <li class="{{ request()->routeIs('admin.order') ? 'active':'' }}">
                <a href="{{ route('admin.order') }}" class="nav-link"><i class="fas fa-water"></i><span>Orders</span></a>
            </li>
            <li class="{{ request()->routeIs('admin.general') ? 'active':'' }}">
                <a href="{{ route('admin.general') }}" class="nav-link"><i class="fas fa-volleyball-ball"></i><span>General Information</span></a>
            </li>
        </ul>
    </aside>
</div>
