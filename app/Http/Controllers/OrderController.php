...
class OrderController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->gateway->setClientId('AdFXUM4InGmRXtAP6V9TvQ4RtaN9l6Gng7CtEBWGEEaWABKXul8Xny79z4s6CgX8A_rW8A1StxeibleR');
        $this->gateway->setSecret('ENJSu83f37Kdxk2A1J-a147S02oEBLtMijjt-2GN5RFF_gI3xZYuAO8kx__mwd6I40aOoQbvGiNxufcY');
    ...
    public function order(Request $request, $user)
    {
        ...
        if ($request->payment_method == 3) {
            ...
            $stripe = new \Stripe\StripeClient('sk_test_51LxqFVI3mZgE8gRtjWIu1w2mN7pXStJYAssFPZ3j8afPYKkiUL5JIKigO8DGJk4b557y7kf1EcFiWL5fi8PpWuQz002IpXO8wE');
